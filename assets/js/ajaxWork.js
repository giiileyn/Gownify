...
function updateCategory(){
    ...
    $.ajax({
      url:'./controller/updateCategories.php',
      method:'post',
      data:fd,
      processData: false,
      contentType: false,
...
function customerDelete(users_id){
    $.ajax({
        url:"./controller/deleteCustomer.php",
        method:"post",
        data:{record:users_id},
        success:function(data){
...
//edit customer data
function editCustomerForm(users_id){
    $.ajax({
...
function orderDetailsDelete(customer_id){
    $.ajax({
        url:"./controller/deleteOrdeDetails.php",
        method:"post",
        data:{record:customer_id},
        success:function(data){
