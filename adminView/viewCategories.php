...
<div >
  ...
  <table class="table ">
    ...
    <tr>
      ...
      <td><button class="btn btn-primary" style="height:40px" onclick="categoryEditForm('<?=$row['category_id']?>')">Edit</button></td>
      <td><button class="btn btn-danger" style="height:40px" onclick="deleteCategory('<?=$row['category_id']?>')">Delete</button></td>
